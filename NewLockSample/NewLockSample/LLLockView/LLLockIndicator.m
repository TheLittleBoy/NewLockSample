...
#define kCircleDiameter 7.0            // 圆点直径
...
- (void)initCircles
{
    ...
    for (int i=0; i<9; i++) {
        ...
        [button setBackgroundImage:[UIImage imageNamed:@"circle_none"] forState:UIControlStateNormal];
        [button setBackgroundImage:[UIImage imageNamed:@"circle_sel"] forState:UIControlStateSelected];
